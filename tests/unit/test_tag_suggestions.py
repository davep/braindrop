...
##############################################################################
async def test_empty_value_no_suggestion(suggest_tags) -> None:
    """An empty value should get no suggestion."""
    assert (await suggest_tags.get_suggestion("")) is None


##############################################################################
async def test_simple_suggestion(suggest_tags) -> None:
...
async def test_no_suggestion_when_no_next_tag(suggest_tags, tail: str) -> None:
...
##############################################################################
async def test_no_repeat_suggestion(suggest_tags) -> None:
...
##############################################################################
async def test_subsequent_suggestion(suggest_tags) -> None:
